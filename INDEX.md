...
| observability | grafana-dashboards | Grafana dashboard creation, panel types, templating variables, provisioning as code, unified alerting, and Grafonnet. Use when building Grafana dashboards or visualizations. Do NOT use for Prometheus query writing, Kibana dashboards, or Datadog. | enriched |
| infrastructure | ansible-playbooks | Ansible playbook authoring, roles, inventory, vault, Jinja2 templates, modules, collections, and testing with Molecule. Use when automating server config with Ansible. Do NOT use for Puppet/Chef/SaltStack, Terraform, or shell scripting. | enriched |
| observability | elk-stack | Elasticsearch queries/mappings, Logstash pipelines, Filebeat/Metricbeat, Kibana dashboards, ILM, and Elastic APM. Use when working with the Elastic/ELK Stack. Do NOT use for Prometheus, Grafana-only, Splunk, or Loki. | enriched |
