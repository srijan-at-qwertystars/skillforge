...
| testing | playwright-testing | Playwright browser automation and e2e testing patterns including locators, assertions, network interception, visual regression, and CI/CD integration. Use when writing browser tests, e2e tests, or UI automation with Playwright. Do NOT use for unit tests without browser, Selenium/Cypress/Puppeteer, or native mobile testing. | enriched |
| infrastructure | pulumi-iac | Pulumi Infrastructure as Code using TypeScript/Python/Go/C# for AWS/Azure/GCP/Kubernetes provisioning, component resources, testing, and Automation API. Use when managing cloud infrastructure with Pulumi. Do NOT use for Terraform, CloudFormation, Ansible, or CDK for Terraform. | enriched |
| observability | prometheus-monitoring | Prometheus monitoring setup, PromQL queries, alerting rules, instrumentation, service discovery, relabeling, and Alertmanager configuration. Use when setting up Prometheus monitoring or writing PromQL. Do NOT use for Datadog/New Relic/Splunk, log aggregation, or distributed tracing. | enriched |
