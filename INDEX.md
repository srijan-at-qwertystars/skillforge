...
| frontend | sveltekit-patterns | SvelteKit 2.x full-stack patterns with Svelte 5 runes, routing, load functions, form actions, hooks, SSR/CSR, and adapters. Use when building with SvelteKit. Do NOT use for React/Next.js, Vue/Nuxt, Astro, or legacy Svelte without SvelteKit. | enriched |
| runtime | bun-runtime | Bun 1.x runtime, package manager, bundler, and test runner patterns including Bun.serve, Bun Shell, SQLite, FFI, and Node.js migration. Use when working with Bun. Do NOT use for Node.js-only, Deno, or browser JavaScript. | enriched |
| security | keycloak-auth | Keycloak 25+ identity management, SSO, OAuth2/OIDC, realms, clients, user federation, identity brokering, authorization services, and custom SPIs. Use when working with Keycloak. Do NOT use for Auth0, Okta, Cognito, or Firebase Auth. | enriched |
