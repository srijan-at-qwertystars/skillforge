...
| utils | regex-patterns | Regex patterns across languages — syntax, common patterns, lookaround, Unicode, ReDoS prevention, debugging | created |
| devtools | git-advanced | Advanced Git techniques — interactive rebase, bisect, reflog, worktrees, hooks, history rewriting, signing | created |
| database | postgres-advanced | Advanced PostgreSQL — query optimization, indexing, partitioning, CTEs, JSONB, FTS, replication, RLS | created |
