...
| frontend | [remix-framework](frontend/remix-framework/) | Remix v2+ full-stack framework with Vite, loaders, actions, nested routing, error boundaries, streaming, resource routes, and React Router v7 migration. Use when building with Remix. Do NOT use for Next.js, plain React SPA, Vue/Nuxt, or Astro. | enriched |
| testing | [cypress-testing](testing/cypress-testing/) | Cypress 13+ E2E and component testing with selectors, intercepts, fixtures, custom commands, cy.session auth, CI parallel runs, and visual regression. Use when testing with Cypress. Do NOT use for Playwright, Selenium, Jest/Vitest unit tests, or mobile testing. | enriched |
| messaging | [rabbitmq-patterns](messaging/rabbitmq-patterns/) | RabbitMQ 3.13+/4.x messaging patterns including AMQP exchanges, work queues, pub/sub, DLX, quorum queues, streams, publisher confirms, and client libraries. Use when working with RabbitMQ. Do NOT use for Kafka, Redis pub/sub, AWS SQS/SNS, or in-process queues. | enriched |
