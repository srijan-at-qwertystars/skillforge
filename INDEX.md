...
| frontend | nuxt-framework | Nuxt 3 full-stack Vue framework — auto-imports, file-based routing, Nitro server, hybrid rendering | enriched |
| devops | chaos-engineering | Chaos engineering principles, tools, experiment design, fault injection, GameDay planning | enriched |
| python | python-typing | Python type hints — generics, protocols, TypedDict, mypy/pyright, runtime checking, Pydantic | enriched |
