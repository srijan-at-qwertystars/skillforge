...
| frontend | pwa-patterns | Progressive Web Apps — service workers, caching strategies, Workbox, push notifications, offline-first | enriched |
| testing | jest-testing | Jest testing — mocking, snapshots, async, React testing, coverage, custom matchers | enriched |
| cloud | azure-bicep | Azure Bicep IaC — modules, types, loops, deployment scopes, registry, testing | enriched |
