...
| cloud | aws-lambda | AWS Lambda function patterns, handlers, event sources, API Gateway integration, cold start optimization, layers, Powertools, and deployment with SAM/CDK. Use when building serverless functions on AWS Lambda. Do NOT use for Azure Functions, Google Cloud Functions, Cloudflare Workers, or ECS/EKS containers. | created |
| frontend | astro-framework | Astro framework for content-driven websites, islands architecture, partial hydration, Content Collections, View Transitions, SSR adapters, and multi-framework integration. Use when building with Astro. Do NOT use for React-only SPAs, Vue/Nuxt, SvelteKit, or Hugo/Jekyll. | created |
| testing | selenium-testing | Selenium WebDriver 4.x browser automation, locators, waits, Actions API, Page Object Model, Grid 4, and cross-browser testing in Python/Java. Use when writing Selenium tests. Do NOT use for Playwright, Cypress, Puppeteer, or native mobile testing. | created |
