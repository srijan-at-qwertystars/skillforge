...
| java | [spring-boot-patterns](java/spring-boot-patterns/) | Spring Boot 3.x — REST controllers, Spring Data JPA, Security, testing, Actuator, GraalVM native | created |
| javascript | [deno-runtime](javascript/deno-runtime/) | Deno 2.x runtime — permissions, Deno.serve, KV, Deploy, Fresh, JSR, npm compat, compile | created |
| devops | [nginx-advanced](devops/nginx-advanced/) | Nginx advanced — reverse proxy, load balancing, SSL/TLS, caching, rate limiting, HTTP/2-3, stream | created |
