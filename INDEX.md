...
| devops | [goreleaser](devops/goreleaser/) | Go binary release automation with GoReleaser — multi-platform builds, GitHub/GitLab releases, Homebrew taps, Docker images, and signing | tested |
...
| devops | [earthly](devops/earthly/) | Earthly build automation — Earthfile syntax, caching, parallelism. Use for reproducible builds. NOT for simple single-step builds. | tested |
| devops | [devbox](devops/devbox/) | Devbox portable dev environments — devbox.json, Nix-based packages. Use for reproducible dev setups. NOT for production deployments. | tested |
| devops | [moon](devops/moon/) | Moon monorepo build system — moon.yml, tasks, remote cache. Use for fast monorepo builds. NOT for single-package projects. | tested |
