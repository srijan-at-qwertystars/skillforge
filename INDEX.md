...
| devops | [docker-swarm](devops/docker-swarm/) | Docker Swarm mode orchestration including services, stacks, overlay networks, secrets, configs, rolling updates, placement constraints, and HA clustering. Use when working with Docker Swarm. Do NOT use for Kubernetes, Docker Compose standalone, ECS/Fargate, or Nomad. | created |
| networking | [grpc-patterns](networking/grpc-patterns/) | gRPC service patterns with Protocol Buffers, unary/streaming RPCs, interceptors, error handling, deadlines, metadata, load balancing, gRPC-Web, and multi-language implementations. Use when building gRPC services. Do NOT use for REST APIs, GraphQL, WebSocket, or browser-only apps. | created |
| security | [oauth2-patterns](security/oauth2-patterns/) | OAuth 2.0/2.1 authorization patterns including PKCE, grant types, OpenID Connect, token management, provider integration, and security best practices. Use when implementing OAuth/OIDC. Do NOT use for simple API keys, basic auth, session-only auth, or SAML. | created |
