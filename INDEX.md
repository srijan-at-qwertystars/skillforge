...
| devops | packer-images | HashiCorp Packer image building with HCL2 templates, multi-cloud builders, and golden image pipelines | enriched |
| frontend | accessibility-patterns | Web accessibility (a11y) with WCAG 2.2, ARIA, keyboard navigation, and screen reader support | enriched |
| devops | feature-flags | Feature flag implementation with OpenFeature, LaunchDarkly, rollout strategies, and flag lifecycle | enriched |
